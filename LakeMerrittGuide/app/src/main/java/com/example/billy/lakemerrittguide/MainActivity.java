...
public class MainActivity extends AppCompatActivity {
    ...
    public void setLakeMerrittDatabase(){
        ...
        if(checkCount<=0) {
            ...
            lakeMerrittHelper.listInsert( RESTAURANTS, GRAND_LAKE, "576 Grand Ave", "510-922-9582", "3 stars", "$$$", "American, Breakfast, Deli", getString(R.string.grandLakeKitchen_info), R.drawable.grandlakekitchenlogo, R.drawable.grandlakerunch1, R.drawable.grandlakebrunch4, NO_FAVORITE_ICON);
            ...
            lakeMerrittHelper.listInsert( ACTIVITIES, JAPANESE_GARDEN, "666 Bellevue Ave", null, null, null, "Parks", getString(R.string.japaneseGardenInfo), R.drawable.japanesegarden1, R.drawable.japanesegarden2, R.drawable.japanesegarden3, NO_FAVORITE_ICON);
