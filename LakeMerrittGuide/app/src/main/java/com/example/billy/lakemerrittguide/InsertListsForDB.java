...
public class InsertListsForDB {
    ...
    public static ArrayList<ThingsToDoClass> getRestaurantsList(Context context){
        ...
        portalRestaurant.setInfoMainImageLogo(R.drawable.portalicon);
        portalRestaurant.setInfoImageOne(R.drawable.portalbrunch1);
        portalRestaurant.setFavoriteStatus(REMOVE_FAVORITE);



        ThingsToDoClass jongGaRestaurant = new ThingsToDoClass(RESTAURANTS_CATEGORY, context.getString(R.string.jongGaName), context.getString(R.string.jong_ga_address), context.getString(R.string.jongGaPhone), context.getString(R.string.five_stars), context.getString(R.string.moderatePrice), context.getString(R.string.korean_type), context.getString(R.string.jongGA_info), R.drawable.jonggalogo, R.drawable.jonggafood1, REMOVE_FAVORITE);
        ...
        ThingsToDoClass rockinCrawfishRestaurant = new ThingsToDoClass(RESTAURANTS_CATEGORY, context.getString(R.string.rockinCrawfishName), context.getString(R.string.rockin_crawfish_address), context.getString(R.string.rockinCrawfishPhone), context.getString(R.string.four_stars), context.getString(R.string.moderatePrice), context.getString(R.string.rockinCrawfish_type), context.getString(R.string.rockinCrawfish_info), R.drawable.rockincrawfishicon, R.drawable.rockinfoods1, REMOVE_FAVORITE);
        ...
        ThingsToDoClass michelBistroRestaurant = new ThingsToDoClass(RESTAURANTS_CATEGORY, context.getString(R.string.michelBistroName), context.getString(R.string.michel_address), context.getString(R.string.michel_phone), context.getString(R.string.four_stars), context.getString(R.string.moderatePrice), context.getString(R.string.michel_type), context.getString(R.string.michelBistro_info), R.drawable.michelbistrologo, R.drawable.michelfood2, REMOVE_FAVORITE);
